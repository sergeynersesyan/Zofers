...
import com.zofers.zofers.messenger.messenger.adapter.viewHolder.ConversationListViewHolder;
...
public class ConversationListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemClickListener {
	...
	public ConversationListAdapter(int userId, ConversationListListener listener) {
		this.userId = userId;
	...
	public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		return ConversationListViewHolder.initialize(parent, this);
	}
